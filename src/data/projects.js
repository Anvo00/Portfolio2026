...
export const projects = [
  // Icebreaker
  {
    ...
    heroImage: "/projects/icebreaker_brief/Hero_Icebreaker.png",
    brief: [
      "Uno tra i primi approcci al design in Accademia Italiana ha riguardato l\’esplorazione personale per poter comprendere il nostro ruolo da designer.",
      "Ci è stato chiesto di scrivere un piccolo testo che contenesse i nostri obiettivi, desideri e aspettative per il corso, per poi realizzare una grafica che ne rappresentasse la visione. ",
    ],
    researchCaption:
  ...
  // Monogramma e pattern
  {
    ...
    heroImage: "/projects/monogram/Hero_Monogram.png",
  ...
  // Materia prima
  {
    ...
    heroImage: "/projects/materia_prima/Hero_Materia.png",
  ...
  // Maschera di Steinberg
  {
    ...
    heroImage: "/projects/maschera/Hero_Maschera.png",
    brief: ["Il progetto parte dall'universo artistico di Saul Steinberg, per il quale l'idea del travestimento e della finzione sociale rappresenta un perno fondamentale dell’esistenza umana. Il brief richiedeva la progettazione e la realizzazione fisica di una maschera che interpretasse il concetto di facciata metaforica come protezione e barriera contro la rivelazione del sé.",
  ...
  // Recreos
  {
    ...
    heroImage: "/projects/recreos/Hero_Recreos.png",
  ...
  // Booklet Recreos
  {
    ...
    heroImage: "/projects/recreos/Hero_Booklet.png",
  ...
  // Palazzo Strozzi
  {
    ...
    heroImage: "/projects/palazzo_strozzi/Hero_Strozzi.png",
